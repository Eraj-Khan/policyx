...
from .views import recieve_data_on_dashboard,list_all_cases,place_package,list_all_packages,update_bid,choose_package,company_plans
urlpatterns = [
    ...
    path('plans/<str:company_name>/', company_plans, name='company_plans')
]