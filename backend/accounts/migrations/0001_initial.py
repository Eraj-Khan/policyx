    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('normal', 'Normal User'), ('company', 'Company User')], default='normal', max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('terms_and_conditions_accepted', models.BooleanField(blank=True, default=False, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
