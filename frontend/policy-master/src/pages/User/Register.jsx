  ...
  return (
    ...
    <h1 className="educationheading"> Education </h1>
                  ...
                  <div className="button">
                    <button 
                      type="submit"
                      className="button_submit flex w-full justify-center rounded-md border border-transparent bg-sky-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                    >
                      Proceed
                    </button>
                  </div>
