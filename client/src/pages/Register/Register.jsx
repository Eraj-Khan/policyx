...
const Register = () => {
  ...
  return (
    ...
    <div className="flex min-h-full">
         <div className="relative hidden w-30 flex-1 lg:block">
        <img
          className=" 	 object-contain"
          src="https://images.pexels.com/photos/4262424/pexels-photo-4262424.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
          alt=""
        />
      </div>
     ...
     <p className="w-80">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad quibusdam optio iusto sequi harum molestiae quo! Hic iste, tempora nostrum repellat error qui dicta voluptatum maxime modi, cumque quam nihil!</p>
     </div>
        ...
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div>
            <img
              ...
              alt="Your Company"
            />
            <h2 className="mt-6 text-3xl font-bold tracking-tight text-gray-900">Registration</h2>
...
<div className="mt-6">
      <form action="#" method="POST" className="space-y-6" onSubmit={handleSubmit}>
        ...
        <div>
          <label htmlFor="income" id="income_label">
            Income:
          </label>
          <input
            type="number"
